...
(contract-call? .pool-borrow set-borrowing-enabled .sbtc)
(contract-call? .pool-borrow set-borrowing-enabled .ststx)
(contract-call? .pool-borrow set-borrowing-enabled .wstx)
(contract-call? .pool-borrow set-borrowing-enabled .xusd)
(contract-call? .pool-borrow set-borrowing-enabled .diko)
(contract-call? .pool-borrow set-borrowing-enabled .usda)
(contract-call? .pool-borrow set-price .ststx u160000000)
